...
import { checkIsIssuer, getOwner, getIssuerName, shortAddress, SUPPORTED_CHAINS, CONTRACT_ADDRESS } from "./utils/contract";
...
import MyRecords    from "./components/MyRecords.jsx";
...
const Icons = {
  ...
  cert:   <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></svg>,
...
export default function App() {
  ...
  const tabs = [
    ...
    { id: "myrecords",label: "Sertifikat Saya", icon: Icons.cert,   show: !!session },
      ...
      {session && (
        <main style={st.main} className="fade-in">
          ...
          <div style={st.tabContent}>
            ...
            {activeTab==="myrecords" && <MyRecords signer={session.signer} provider={session.provider} address={session.address}/>}
...
const st = {
  ...
  walletAddr:    { fontSize:"11px", fontFamily:"'JetBrains Mono', monospace", color:"#64748b" },
